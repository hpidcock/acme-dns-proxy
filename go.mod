module github.com/hpidcock/acme-dns-proxy
...
require (
	...
	github.com/matthiasng/libdnsfactory v0.0.0-20201026155908-87bdca3ef148
...
require (
	...
	github.com/digitalocean/godo v1.49.0 // indirect
